...
class TestM8Immersive(unittest.TestCase):
    def test_loading_animation_trigger(self):
        ...
        mock_session.execute.return_value.scalars.return_value.first.return_value = (
            MagicMock(id="U", name="Test", level=1)
        )
        mock_ctx = MagicMock()
        ...
        with (
            ...
            patch(
                "app.services.flex_renderer.flex_renderer.render_status"
            ) as mock_render,
            patch(
    ...
    def test_mentor_persona(self):
        ...
        with (
            ...
            patch("app.core.database.AsyncSessionLocal", return_value=mock_ctx),
            patch(
                "app.services.inventory_service.inventory_service.use_item",
                new_callable=AsyncMock,
            ) as mock_use,
            patch(
                "app.services.user_service.user_service.get_or_create_user",
    ...
    def test_viper_persona_push(self):
        ...
        with (
            ...
            patch(
                "app.services.daily_briefing_service.AsyncSessionLocal",
