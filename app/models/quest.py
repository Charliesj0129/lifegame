from sqlalchemy import Column, String, Boolean, Integer, JSON, ForeignKey, Enum, Date, DateTime
...
class Rival(Base):
    ...
    user_id = Column(String, ForeignKey("users.id"), nullable=False) # Each user has their own instance of Viper? Or global? Assuming per user for now.
