...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('rarity', sa.Enum('COMMON', 'UNCOMMON', 'RARE', 'EPIC', 'LEGENDARY', name='itemrarity'), nullable=True),
        sa.Column('type', sa.Enum('CONSUMABLE', 'REWARD', 'KEY', name='itemtype'), nullable=True),
